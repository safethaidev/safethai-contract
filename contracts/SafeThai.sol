...
contract SafeThai is Context, IERC20, Ownable {
	...
	// In case of emergency bug dev must be able to setFundManager
	// If dev set fund manager falsy, price will go down to zero and dev only earn fund after setting manager which is very little
    function setFundManager(address payable _fundManager) public {
        require(msg.sender == fundManager || msg.sender == devAddress, "Not FundManager");
